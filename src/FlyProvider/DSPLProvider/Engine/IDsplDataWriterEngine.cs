...
namespace DsplDataFormat.Engine
{
    ...
    public interface IDsplDataWriterEngine : IWriterEngine
    {
        ...
        /// <summary>
        ///    Writes the Zip file and put this in TextWriter in input
        /// </summary>
        void CloseAndZip(System.IO.StreamWriter tw);
        
        /// <summary>
        /// Delete all file and Directory temporary create in build phase
        /// </summary>
        ...
        /// <param name="RetreiveCodelist" >Delegate for Retreive Codelist</param>
        /// <exception cref="System.ArgumentException">
        /// if the dsd is null
        /// </exception>
        void StartDataset(IDataflowObject dataflow, IDataStructureObject dsd, DsplBaseDataWriter.RetreiveCodelistDelegate RetreiveCodelist);
