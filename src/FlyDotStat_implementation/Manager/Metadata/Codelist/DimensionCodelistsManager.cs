        ...
        internal List<ICodeMutableObject> InternalGetDimensionCodelistConstrain(string DataflowCode, string ConceptId)
        {
            try
            {
                ...
                { 
                    ...
                    new ParameterValue() { Item = "Depth", Value = 1 ,SqlType=System.Data.SqlDbType.Bit} ,
                ...
                if (risposta.Count == 1 && risposta[0].Name == "DataSet" && risposta[0].ChildNodes.Count == 1 && risposta[0].ChildNodes[0].Name == "Dimension")
                {
                    _CodesObjects.AddRange(GetRecurviveDimension(risposta[0].ChildNodes[0].ChildNodes, null));
                }
